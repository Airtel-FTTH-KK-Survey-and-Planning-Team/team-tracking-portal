    ...
    return function t(e, a, i) {
        ...
        3: [function(t, e, a) {
            ...
            o.prototype.setValues = function(t, e) {
                ...
                if (n.alpha = Math.max(0, Math.min(1, void 0 === s ? n.alpha : s)),
                "alpha" === t)
                    return !1;
                var u;
                for (a = 0; a < t.length; a++)
        ...
        4: [function(t, e, a) {
            function i(t) {
                ...
                return l == s ? e = 0 : n == l ? e = (o - r) / u : o == l ? e = 2 + (r - n) / u : r == l && (e = 4 + (n - o) / u),
                e = Math.min(60 * e, 360),
                e < 0 && (e += 360),
                i = (s + l) / 2,
                a = l == s ? 0 : i <= .5 ? u / (l + s) : u / (2 - l - s),
                [e, 100 * a, 100 * i]
            }
            function n(t) {
                var e, a, i, n = t[0], o = t[1], r = t[2], s = Math.min(n, o, r), l = Math.max(n, o, r), u = l - s;
                return a = 0 == l ? 0 : u / l * 1e3 / 10,
                l == s ? e = 0 : n == l ? e = (o - r) / u : o == l ? e = 2 + (r - n) / u : r == l && (e = 4 + (n - o) / u),
                e = Math.min(60 * e, 360),
                e < 0 && (e += 360),
                i = l / 255 * 1e3 / 10,
                [e, a, i]
            ...
            function h(t) {
                ...
                for (var u = 0; u < 3; u++)
                    ...
                    i < 0 && i++,
                    i > 1 && i--,
                    o = 6 * i < 1 ? e + 6 * (a - e) * i : 2 * i < 1 ? a : 3 * i < 2 ? e + (a - e) * (2 / 3 - i) * 6 : e,
                    n[u] = 255 * o;
                return n
            }
            function f(t) {
            ...
            function R(t) {
                ...
                return e = 3.2406 * n + o * -1.5372 + r * -.4986,
            ...
            function B(t) {
                ...
                return o <= 8 ? (a = 100 * o / 903.3,
                n = 7.787 * (a / 100) + 16 / 116) : (a = 100 * Math.pow((o + 16) / 116, 3),
                n = Math.pow(a / 100, 1 / 3)),
                e = e / 95.047 <= .008856 ? e = 95.047 * (r / 500 + n - 16 / 116) / 7.787 : 95.047 * Math.pow(r / 500 + n, 3),
                i = i / 108.883 <= .008859 ? i = 108.883 * (n - s / 200 - 16 / 116) / 7.787 : 108.883 * Math.pow(n - s / 200, 3),
                [e, a, i]
            }
            function z(t) {
                var e, a, i, n = t[0], o = t[1], r = t[2];
                ...
                t.controllers.bar = t.DatasetController.extend({
                    ...
                    getStackIndex: function(t) {
                        ...
                        for (a = 0; a < t; ++a)
                            ...
                            e.bar && this.chart.isDatasetVisible(a) && (o.options.stacked === !1 || o.options.stacked === !0 && r.indexOf(e.stack) === -1 || void 0 === o.options.stacked && (void 0 === e.stack || r.indexOf(e.stack) === -1)) && r.push(e.stack);
                        return r.length - 1
                    },
                    calculateBarX: function(t, e, a) {
                        ...
                        return s -= i.chart.isCombo ? a.tickWidth / 2 : 0,
                        s + a.barWidth / 2 + a.categorySpacing + a.barWidth * r + a.barSpacing / 2 + a.barSpacing * r
                    },
                    ...
                    draw: function(e) {
                        ...
                        for (t.canvasHelpers.clipArea(n.chart.chart.ctx, n.chart.chartArea),
                        a = 0,
                        i = r.length; a < i; ++a) {
                            var l = s.data[a];
                ...
                t.controllers.horizontalBar = t.controllers.bar.extend({
                    ...
                    calculateBarY: function(t, e, a) {
                        var i = this
                          ...
                          , r = i.getStackIndex(e)
                          , s = o.getPixelForValue(null, t, e, i.chart.isCombo);
                        return s -= i.chart.isCombo ? a.tickHeight / 2 : 0,
                        s + a.barHeight / 2 + a.categorySpacing + a.barHeight * r + a.barSpacing / 2 + a.barSpacing * r
                    }
                })
            }
        }
            ...
            e.exports = function(t) {
                ...
                a.doughnut = {
                    ...
                    legend: {
                        ...
                        onClick: function(t, e) {
                            ...
                            for (a = 0,
                            i = (r.data.datasets || []).length; a < i; ++a)
                ...
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                    ...
                    update: function(t) {
                        ...
                        a.innerRadius = Math.max(a.outerRadius - i.radiusLength, 0),
                    ...
                    updateElement: function(t, a, i) {
                        ...
                        i && l.animateRotate || (0 === a ? b.startAngle = s.rotation : b.startAngle = n.getMeta().data[a - 1]._model.endAngle,
                ...
                t.controllers.line = t.DatasetController.extend({
                    ...
                    getPointBorderWidth: function(t, e) {
                        var i = this.chart.options.elements.point.borderWidth
                          , n = this.getDataset()
                          , o = t.custom || {};
                        return isNaN(o.borderWidth) ? isNaN(n.pointBorderWidth) ? isNaN(n.borderWidth) || (i = n.borderWidth) : i = a.getValueAtIndexOrDefault(n.pointBorderWidth, e, i) : i = o.borderWidth,
                        i
                    },
                    updateElement: function(t, e, i) {
                        ...
                        n = f.getPixelForValue("object" == typeof c ? c : NaN, e, d, m),
                    ...
                    calculatePointY: function(t, e, a) {
                        ...
                        if (u.options.stacked) {
                            for (i = 0; i < a; i++)
                                if (n = s.data.datasets[i],
                                o = s.getDatasetMeta(i),
                                "line" === o.type && o.yAxisID === u.id && s.isDatasetVisible(i)) {
                    ...
                    updateBezierControlPoints: function() {
                        ...
                        "monotone" === l.dataset._model.cubicInterpolationMode)
                            ...
                            i = d.length; e < i; ++e)
                                n = d[e],
                                o = n._model,
                                r = a.splineCurve(a.previousItem(d, e)._model, o, a.nextItem(d, e)._model, l.dataset._model.tension),
                    ...
                    draw: function(a) {
                        ...
                        n = s.length; i < n; ++i)
                            s[i].transition(l);
                        for (t.canvasHelpers.clipArea(o.chart.chart.ctx, o.chart.chartArea),
                        e(o.getDataset(), o.chart.options) && r.dataset.transition(l).draw(),
            ...
            e.exports = function(t) {
                ...
                t.animationService = {
                    ...
                    cancelAnimation: function(t) {
                        ...
                        a !== -1 && (this.animations.splice(a, 1),
                        t.animating = !1)
                    },
        ...
        22: [function(t, e, a) {
            ...
            e.exports = function(t) {
                ...
                e.drawPoint = function(e, a, i, n, o) {
                    var r, s, l, u, d, c;
                    if ("object" == typeof a && (r = a.toString(),
            ...
            e.exports = function(t) {
                ...
                i.extend(t.Controller.prototype, {
                    ...
                    resize: function(t) {
                        ...
                        if ((a.width !== l || a.height !== u) && (r.width = a.width = l,
                        r.height = a.height = u,
                        r.style.width = l + "px",
                        r.style.height = u + "px",
                        i.retinaScale(a),
                    ...
                    updateLayout: function() {
                        var e = this;
                        n.notify(e, "beforeLayout") !== !1 && (t.layoutService.update(this, this.chart.width, this.chart.height),
                    ...
                    draw: function(t) {
                        ...
                        e.clear(),
                        void 0 !== t && null !== t || (t = 1),
                        n.notify(e, "beforeDraw", [t]) !== !1 && (i.each(e.boxes, function(t) {
                            t.draw(e.chartArea)
                        }, e),
                    ...
                    destroy: function() {
                        ...
                        for (s.stop(),
                        a = 0,
                        r = s.data.datasets.length; a < r; ++a)
                    ...
                    eventHandler: function(t) {
                        ...
                        if (n.notify(e, "beforeEvent", [t]) !== !1) {
                            ...
                            return o ? e.render(o.duration, o.lazy) : i && !e.animating && (e.stop(),
                    ...
                    handleEvent: function(t) {
                        ...
                        "mouseout" === t.type ? e.active = [] : e.active = e.getElementsAtEventForMode(t, n.mode, n),
                        n.onHover && n.onHover.call(e, t.native, e.active),
                        "mouseup" !== t.type && "click" !== t.type || a.onClick && a.onClick.call(e, t.native, e.active),
                ...
                i.extend(t.DatasetController.prototype, {
                    ...
                    removeHoverStyle: function(t, e) {
                        var a = this.chart.data.datasets[t._datasetIndex]
                          ...
                          , s = t._model;
                        s.backgroundColor = o.backgroundColor ? o.backgroundColor : r(a.backgroundColor, n, e.backgroundColor),
                        s.borderColor = o.borderColor ? o.borderColor : r(a.borderColor, n, e.borderColor),
                        s.borderWidth = o.borderWidth ? o.borderWidth : r(a.borderWidth, n, e.borderWidth)
                    },
                    setHoverStyle: function(t) {
                        var e = this.chart.data.datasets[t._datasetIndex]
                          , a = t._index
                          ...
                          , r = i.getHoverColor
                          , s = t._model;
                        s.backgroundColor = n.hoverBackgroundColor ? n.hoverBackgroundColor : o(e.hoverBackgroundColor, a, r(s.backgroundColor)),
                        s.borderColor = n.hoverBorderColor ? n.hoverBorderColor : o(e.hoverBorderColor, a, r(s.borderColor)),
                        s.borderWidth = n.hoverBorderWidth ? n.hoverBorderWidth : o(e.hoverBorderWidth, a, s.borderWidth)
                    },
        ...
        26: [function(t, e, a) {
            ...
            e.exports = function(t) {
                function e(t, e, a) {
                    ...
                    t.indexOf("%") !== -1 && (i = i / 100 * e.parentNode[a])) : i = t,
                    i
                }
                function a(t) {
                ...
                o.splineCurveMonotone = function(t) {
                    ...
                    for (e = 0; e < s - 1; ++e)
                        i = r[e],
                        n = r[e + 1],
                        i.model.skip || n.model.skip || (o.almostEquals(i.deltaK, 0, this.EPSILON) ? i.mK = n.mK = 0 : (u = i.mK / i.deltaK,
                        d = n.mK / i.deltaK,
                ...
                o.niceNum = function(t, e) {
                    ...
                    return a = e ? n < 1.5 ? 1 : n < 3 ? 2 : n < 7 ? 5 : 10 : n <= 1 ? 1 : n <= 2 ? 2 : n <= 5 ? 5 : 10,
                    a * Math.pow(10, i)
                }
                ;
                var r = o.easingEffects = {
                    ...
                    easeInOutElastic: function(t) {
                        ...
                        i < Math.abs(1) ? (i = 1,
                        e = a / 4) : e = a / (2 * Math.PI) * Math.asin(1 / i),
                        t < 1 ? -.5 * (i * Math.pow(2, 10 * (t -= 1)) * Math.sin((1 * t - e) * (2 * Math.PI) / a)) : i * Math.pow(2, -10 * (t -= 1)) * Math.sin((1 * t - e) * (2 * Math.PI) / a) * .5 + 1)
                    },
                ...
                o.getRelativePosition = function(t, e) {
                    ...
                    l && l.length > 0 ? (a = l[0].clientX,
                    i = l[0].clientY) : (a = n.clientX,
                    i = n.clientY);
                    ...
                    return a = Math.round((a - s.left - u) / f * r.width / e.currentDevicePixelRatio),
                    i = Math.round((i - s.top - d) / g * r.height / e.currentDevicePixelRatio),
                    {
                        x: a,
                        y: i
                    }
            ...
            e.exports = function(t) {
                ...
                function n(t, e, i, n) {
                    var o = Number.POSITIVE_INFINITY
                      , s = [];
                    return n || (n = r.distanceBetweenPoints),
                    a(t, function(t) {
                ...
                t.layoutService = {
                    ...
                    update: function(t, a, i) {
                        function n(t) {
                            ...
                            a ? (e = t.update(t.options.fullWidth ? x : C, w),
                            I -= e.height) : (e = t.update(M, S),
                            C -= e.width),
                            D.push({
                                horizontal: a,
                                minSize: e,
            ...
            e.exports = function(t) {
                        ...
                        r)
                            ...
                            m) {
                                ...
                                i.each(a.legendItems, function(t, i) {
                                    ...
                                    v[v.length - 1] + r + o.padding >= a.width && (b += d + o.padding,
                                    v[v.length] = a.left),
                                    g[i] = {
                                        left: 0,
                                        top: 0,
                    ...
                    draw: function() {
                        ...
                        if (n.display) {
                            ...
                            i.each(a.legendItems, function(t, e) {
                                ...
                                S ? r + n >= l && (s = d.y += M,
                                d.line++,
                                r = d.x = a.left + (l - u[d.line]) / 2) : s + M > a.bottom && (r = d.x = r + a.columnWidths[d.line] + o.padding,
                ...
                t.plugins.register({
                    ...
                    beforeUpdate: function(e) {
                        ...
                        n ? (n = i.configMerge(t.defaults.global.legend, n),
                        e.legend ? e.legend.options = n : a(e, n)) : (t.layoutService.removeBox(e, e.legend),
                        delete e.legend)
                    },
                ...
                t.plugins = {
                    ...
                    notify: function(t, e, a) {
                        ...
                        for (i = 0; i < u; ++i)
                            ...
                            o = n.plugin,
                            s = o[e],
                            "function" == typeof s && (r = [t].concat(a || []),
                            r.push(n.options),
                            s.apply(o, r) === !1))
                                return !1;
                        return !0
            ...
            e.exports = function(t) {
                ...
                t.Scale = t.Element.extend({
                    ...
                    fit: function() {
                        ...
                        if (d ? n.width = t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : n.width = u && l.drawTicks ? f : 0,
                        d ? n.height = u && l.drawTicks ? f : 0 : n.height = t.maxHeight,
                        ...
                        r.display && u) {
                            ...
                            if (d) {
                                ...
                                var k = t.ticks[0]
                                  ...
                                  , w = e(t.ctx, M, c.font);
                                0 !== t.labelRotation ? (t.paddingLeft = "bottom" === o.position ? b * S + 3 : b * m + 3,
                                t.paddingRight = "bottom" === o.position ? b * m + 3 : b * w + 3) : (t.paddingLeft = S / 2 + 3,
                    ...
                    draw: function(e) {
                        ...
                        if (o.display) {
                            ...
                            if (p) {
                                if (r = !1,
                                f && (C /= 2),
                                (C + d.autoSkipPadding) * n.ticks.length > n.width - (n.paddingLeft + n.paddingRight) && (r = 1 + Math.floor((C + d.autoSkipPadding) * n.ticks.length / (n.width - (n.paddingLeft + n.paddingRight)))),
                                s && n.ticks.length > s)
                            ...
                            if (i.each(n.ticks, function(t, a) {
                                if (void 0 !== t && null !== t) {
                                    ...
                                    if ((!l || s) && void 0 !== t && null !== t) {
                                        var u, h;
                                        a === ("undefined" != typeof n.zeroLineIndex ? n.zeroLineIndex : 0) ? (u = c.zeroLineWidth,
                                        h = c.zeroLineColor) : (u = i.getValueAtIndexOrDefault(c.lineWidth, a),
                                        h = i.getValueAtIndexOrDefault(c.color, a));
                                        var g, m, v, k, S, w, C, _, F, V, R = "middle", O = "middle";
                                        if (p) {
                                            "bottom" === o.position ? (O = f ? "middle" : "top",
                                            R = f ? "right" : "center",
                                            V = n.top + b) : (O = f ? "middle" : "bottom",
                                            R = f ? "left" : "center",
                                            V = n.bottom - b);
                                            var L = n.getPixelForTick(a) + i.aliasPixel(u);
                                            F = n.getPixelForTick(a, c.offsetGridLines) + d.labelOffset,
                                            g = v = S = C = L,
                                            m = T,
                                            k = P,
                                            w = e.top,
                            ...
                            if (c.drawBorder) {
                                ...
                                p ? (B = z = "top" === o.position ? n.bottom : n.top,
                                B += W,
                                z += W) : (O = L = "left" === o.position ? n.right : n.left,
                                O += W,
                                L += W),
                                l.beginPath(),
                                l.moveTo(O, B),
                ...
                t.Ticks = {
                    generators: {
                        linear: function(t, a) {
                            ...
                            t.min && t.max && t.stepSize && e.almostWhole((t.max - t.min) / t.stepSize, i / 1e3) && (r = t.min,
                            s = t.max);
                            var l = (s - r) / i;
                            ...
                            for (var u = 1; u < l; ++u)
                                n.push(r + u * i);
                            return n.push(void 0 !== t.max ? t.max : s),
                            n
                        },
                        logarithmic: function(t, a) {
                            ...
                            0 === s ? (i = Math.floor(e.log10(a.minNotZero)),
                            n = Math.floor(a.minNotZero / Math.pow(10, i)),
                            o.push(s),
                            s = n * Math.pow(10, i)) : (i = Math.floor(e.log10(s)),
            ...
            e.exports = function(t) {
                ...
                t.Title = t.Element.extend({
                    ...
                    fit: function() {
                        ...
                        l.height = r ? s + 2 * n.padding : 0) : (l.width = r ? s + 2 * n.padding : 0,
                    ...
                    draw: function() {
                        ...
                        if (o.display) {
                            ...
                            i.font = f,
                            e.isHorizontal() ? (s = m + (b - m) / 2,
                            l = p + (v - p) / 2,
                            u = b - m) : (s = "left" === o.position ? m + d / 2 : b - d / 2,
                            l = p + (v - p) / 2,
                            u = v - p,
                ...
                t.plugins.register({
                    ...
                    beforeUpdate: function(i) {
                        ...
                        n ? (n = a.configMerge(t.defaults.global.title, n),
                        i.titleBlock ? i.titleBlock.options = n : e(i, n)) : (t.layoutService.removeBox(i, i.titleBlock),
                        delete i.titleBlock)
                    }
                })
            }
        ...
        36: [function(t, e, a) {
            ...
            e.exports = function(t) {
                ...
                function o(t, e) {
                    ...
                    return a.font = l.fontString(d, e._titleFontStyle, e._titleFontFamily),
                    l.each(e.title, g),
                    ...
                    f = 0,
                    a.font = l.fontString(h, e._footerFontStyle, e._footerFontFamily),
                    l.each(e.footer, g),
                    n += 2 * e.xPadding,
                    {
                        width: n,
                ...
                function s(t, e, a) {
                    ...
                    "top" === u ? n += d : n -= "bottom" === u ? e.height + d : e.height / 2,
                ...
                t.Tooltip = t.Element.extend({
                    ...
                    update: function(e) {
                        var a, u, d = this, c = d._options, h = d._model, f = d._model = n(c), g = d._active, p = d._data, m = d._chartInstance, v = {
                            xAlign: h.xAlign,
                            yAlign: h.yAlign
                        }, b = {
                            x: h.x,
                    ...
                    drawTitle: function(t, a, i, n) {
                        ...
                        if (o.length) {
                            ...
                            i.font = l.fontString(r, a._titleFontStyle, a._titleFontFamily);
                            var u, d;
                            for (u = 0,
                            d = o.length; u < d; ++u)
                    ...
                    drawBody: function(t, a, i, n) {
                        ...
                        i.fillStyle = u,
                        i.font = l.fontString(o, a._bodyFontStyle, a._bodyFontFamily);
                        var d = 0
                          , c = function(e) {
                        ...
                        l.each(s, function(r, s) {
                            ...
                            l.each(r.lines, function(r) {
                                ...
                                i.strokeStyle = e(a.labelColors[s].borderColor, n),
                                i.strokeRect(t.x, t.y, o, o),
                                i.fillStyle = e(a.labelColors[s].backgroundColor, n),
                    ...
                    drawFooter: function(t, a, i, n) {
                        ...
                        i.font = l.fontString(a.footerFontSize, a._footerFontStyle, a._footerFontFamily),
                        l.each(o, function(e) {
                    ...
                    drawBackground: function(t, a, i, n, o) {
                        ...
                        l.drawRoundedRectangle(i, t.x, t.y, n.width, n.height, a.cornerRadius),
                        i.fill()
                    },
                    draw: function() {
            ...
            e.exports = function(t) {
                ...
                t.elements.Line = t.Element.extend({
                    draw: function() {
                        function t(t, e) {
                            var a = e._view;
                            e._view.steppedLine === !0 ? (l.lineTo(a.x, t._view.y),
                            l.lineTo(a.x, a.y)) : 0 === e._view.tension ? l.lineTo(a.x, a.y) : l.bezierCurveTo(t._view.controlPointNextX, t._view.controlPointNextY, a.controlPointPreviousX, a.controlPointPreviousY, a.x, a.y)
                        }
                        var i = this
                          , n = i._view
                          , o = n.spanGaps
                        ...
                        if (u.length && n.fill) {
                            ...
                            c = 0; c < u.length; ++c)
                                ...
                                g = h._view,
                                0 === c ? (s ? l.moveTo(r.x, r.y) : l.moveTo(g.x, r),
                                g.skip || (d = c,
                                l.lineTo(g.x, g.y))) : (f = d === -1 ? f : u[d],
                                g.skip ? o || d !== c - 1 || (s ? l.lineTo(r.x, r.y) : l.lineTo(f._view.x, r)) : (d !== c - 1 ? o && d !== -1 ? t(f, h) : s ? l.lineTo(g.x, g.y) : (l.lineTo(g.x, r),
                        ...
                        for (l.lineCap = n.borderCapStyle || p.borderCapStyle,
                        l.setLineDash && l.setLineDash(n.borderDash || p.borderDash),
                        l.lineDashOffset = n.borderDashOffset || p.borderDashOffset,
                        ...
                        c = 0; c < u.length; ++c)
                            ...
                            d = c) : (f = d === -1 ? f : u[d],
                            g.skip || (d !== c - 1 && !o || d === -1 ? l.moveTo(g.x, g.y) : t(f, h),
                            d = c));
                        l.stroke(),
                        l.restore()
                    }
                ...
                t.elements.Point = t.Element.extend({
                    ...
                    draw: function(e) {
                        var a = this._view
                          ...
                          , f = 1.01
                          , g = 0;
                        a.skip || (s.strokeStyle = a.borderColor || o,
                        s.lineWidth = i.getValueOrDefault(a.borderWidth, n.elements.point.borderWidth),
                        s.fillStyle = a.backgroundColor || o,
                        void 0 !== e && (r.x < e.left || e.right * f < r.x || r.y < e.top || e.bottom * f < r.y) && (r.x < e.left ? g = (d - r.x) / (e.left - r.x) : e.right * f < r.x ? g = (r.x - d) / (r.x - e.right) : r.y < e.top ? g = (c - r.y) / (e.top - r.y) : e.bottom * f < r.y && (g = (r.y - c) / (r.y - e.bottom)),
                  ...
                  , i = t.Scale.extend({
                    ...
                    getPixelForValue: function(t, e, a, i) {
                        ...
                        if (n.isHorizontal()) {
                            var l = n.width / o
                              , u = l * (e - n.minIndex);
                            return (n.options.gridLines.offsetGridLines && i || n.maxIndex === n.minIndex && i) && (u += l / 2),
                            n.left + Math.round(u)
                        }
                        var d = n.height / o
                          , c = d * (e - n.minIndex);
                        return n.options.gridLines.offsetGridLines && i && (c += d / 2),
                        n.top + Math.round(c)
                    },
                    getPixelForTick: function(t, e) {
                ...
                var e = t.helpers
                  ...
                  , i = t.LinearScaleBase.extend({
                        ...
                        i.stacked || l) {
                            ...
                            e.each(r, function(o, r) {
                                ...
                                n.isDatasetVisible(r) && t(s) && e.each(o.data, function(t, e) {
                                    ...
                                    isNaN(n) || s.data[e].hidden || (d[e] = d[e] || 0,
                                    c[e] = c[e] || 0,
                                    i.relativePoints ? d[e] = 100 : n < 0 ? c[e] += n : d[e] += n)
                                })
                            }),
                            e.each(u, function(t) {
                    ...
                    getPixelForValue: function(t) {
                        ...
                        return a.isHorizontal() ? (e = a.left + a.width / o * (n - i),
                        Math.round(e)) : (e = a.bottom - a.height / o * (n - i),
                        Math.round(e))
                    },
                    getValueForPixel: function(t) {
                        var e = this
                ...
                var e = t.helpers
                  ...
                  , i = t.Scale.extend({
                        ...
                        i.stacked || d) {
                            ...
                            e.each(s, function(n, r) {
                                var s = o.getDatasetMeta(r)
                                  , l = [s.type, void 0 === i.stacked && void 0 === s.stack ? r : "", s.stack].join(".");
                                o.isDatasetVisible(r) && t(s) && (void 0 === c[l] && (c[l] = []),
                                e.each(n.data, function(t, e) {
                                    var n = c[l]
                                      , o = +a.getRightValue(t);
                                    isNaN(o) || s.data[e].hidden || (n[e] = n[e] || 0,
                    ...
                    getPixelForValue: function(t) {
                        ...
                        0 === s ? i = o.left : (a = o.width,
                        i = o.left + a / n * (e.log10(s) - e.log10(r)))) : (a = o.height,
                        0 !== r || u.reverse ? 0 === o.end && u.reverse ? (n = e.log10(o.start) - e.log10(o.minNotZero),
                        i = s === o.end ? o.top : s === o.minNotZero ? o.top + .02 * a : o.top + .02 * a + .98 * a / n * (e.log10(s) - e.log10(o.minNotZero))) : (n = e.log10(o.end) - e.log10(r),
                        a = o.height,
                        i = o.bottom - a / n * (e.log10(s) - e.log10(r))) : (n = e.log10(o.end) - e.log10(o.minNotZero),
                        i = s === r ? o.bottom : s === o.minNotZero ? o.bottom - .02 * a : o.bottom - .02 * a - .98 * a / n * (e.log10(s) - e.log10(o.minNotZero)))),
                        i
                    },
                    getValueForPixel: function(t) {
                        var a, i, n = this, o = e.log10(n.end) - e.log10(n.start);
                        return n.isHorizontal() ? (i = n.width,
                        a = n.start * Math.pow(10, (t - n.left) * o / i)) : (i = n.height,
        ...
        47: [function(t, e, a) {
            ...
            e.exports = function(t) {
                ...
                function o(t) {
                    var o, r, s, l = a(t), u = Math.min(t.height / 2, t.width / 2), d = {
                        l: t.width,
                        r: 0,
                        t: t.height,
                        b: 0
                ...
                function c(t, a, i, n) {
                    var o = t.ctx;
                    if (o.strokeStyle = f.getValueAtIndexOrDefault(a.color, n - 1),
                ...
                var f = t.helpers
                  ...
                  , m = t.LinearScaleBase.extend({
                        ...
                        f.each(e.data.datasets, function(n, o) {
                            if (e.isDatasetVisible(o)) {
                                ...
                                f.each(n.data, function(e, n) {
                                    ...
                                    isNaN(o) || r.data[n].hidden || (a = Math.min(o, a),
                                    i = Math.max(o, i))
                                })
                            }
                        }),
                    ...
                    setReductions: function(t, e, a) {
                        ...
                        r = h(r),
                        s = h(s),
                        i.drawingArea = Math.min(Math.round(t - (n + o) / 2), Math.round(t - (r + s) / 2)),
                                ...
                                if (l > 0 || e.reverse) {
                                    ...
                                    i.display) {
                                        ...
                                        i.showLabelBackdrop) {
                                            ...
                                            o.fillRect(t.xCenter - p / 2 - i.backdropPaddingX, h - r / 2 - i.backdropPaddingY, p + 2 * i.backdropPaddingX, r + 2 * i.backdropPaddingY)
                                        }
                                        o.textAlign = "center",
                  ...
                  , o = t.Scale.extend({
                    ...
                    determineDataLimits: function() {
                        ...
                        e.each(t.chart.data.datasets, function(n, o) {
                            ...
                            "object" == typeof n.data[0] && null !== n.data[0] ? e.each(n.data, function(e) {
                                ...
                                r.push(a),
                                s && (t.firstTick = null !== t.firstTick ? i.min(t.firstTick, a) : a,
                    ...
                    buildTicks: function() {
                        ...
                        !i.options.time.max) {
                            ...
                            k < 0 ? i.lastTick = i.getMomentStartOf(i.lastTick.add(1, i.tickUnit)) : k >= 0 && (i.lastTick = y),
                            i.scaleSizeInUnits = i.lastTick.diff(i.firstTick, i.tickUnit, !0)
                        }
                        ...
                        0 === w && 0 !== i.scaleSizeInUnits || (i.options.time.max ? (i.ticks.push(i.lastTick.clone()),
                    ...
                    getLabelForIndex: function(t, e) {
                        ...
                        return null !== n && "object" == typeof n && (i = a.getRightValue(n)),
